    ...
    <div class="grid w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/80 shadow-2xl md:grid-cols-2">
      ...
      <section class="p-8">
        ...
        <form method="post" class="space-y-3">
          ...
          <button class="w-full rounded-lg bg-cyan-600 p-3 font-semibold text-white hover:bg-cyan-500">Login</button>
        </form>
        <p class="mt-4 text-sm text-slate-400">No account? <a class="font-medium text-cyan-400" href="/dev/register">Register</a></p>
        <p class="mt-2 text-sm text-slate-500">Need another portal? <a class="text-blue-400" href="/login">Login</a></p>
      </section>
    </div>
  </div>
