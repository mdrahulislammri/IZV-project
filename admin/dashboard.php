...
<div class="mb-6 flex items-center justify-between"><h1 class="text-3xl font-black">Admin Dashboard</h1><details class="relative"><summary class="cursor-pointer rounded border bg-white px-4 py-2">⋮ Menu</summary><div class="absolute right-0 mt-2 w-48 rounded border bg-white p-2 shadow space-y-1"><a class="block rounded px-2 py-1 hover:bg-slate-100" href="/admin/dashboard">Dashboard</a><a class="block rounded px-2 py-1 hover:bg-slate-100" href="/admin/users">Users</a><a class="block rounded px-2 py-1 hover:bg-slate-100" href="/admin/categories">Categories</a><a class="block rounded px-2 py-1 hover:bg-slate-100" href="/admin/warns">Warns</a><a class="block rounded px-2 py-1 hover:bg-slate-100" href="/admin/tickets">Tickets</a><a class="block rounded px-2 py-1 text-red-600 hover:bg-red-50" href="/logout">Logout</a></div></details></div>
