...
<head>
  ...
  <title>Admin Login | ScriptDeploy</title>
  ...
  <div class="mx-auto flex min-h-screen max-w-4xl items-center justify-center">
    <div class="grid w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/85 shadow-2xl md:grid-cols-2">
      <section class="hidden bg-black/60 p-8 md:block">
        ...
        <h1 class="text-3xl font-black">Admin Control Login</h1>
      ...
      <section class="p-8">
        <h2 class="mb-1 text-2xl font-bold">Admin Login</h2>
        ...
        <form method="post" class="space-y-3">
          ...
          <button class="w-full rounded-lg bg-red-600 p-3 font-semibold text-white hover:bg-red-500">Admin Login</button>
        </form>
        <p class="mt-4 text-sm text-slate-500">Buyer login: <a class="text-blue-400" href="/login">/login</a> · Developer login: <a class="text-cyan-400" href="/dev/login">/dev/login</a></p>
      </section>
    </div>
  </div>
